...
public class MissingSexLogin extends LoginStrategy {
    private String dni;
    private String nroTramite;

    private MissingSexLogin(IChromosomeFactory<TestCase> chromosomeFactory, int totalSteps) {
        super(chromosomeFactory, totalSteps);
    }

    public MissingSexLogin(IChromosomeFactory<TestCase> chromosomeFactory) {
